...
public class GameComp {
    // Background
    public static final Color COLOR_BG = new Color(30, 144, 255);           // Biru Terang (Dodger Blue)
    public static final Color COLOR_BG_STATUS = new Color(65, 105, 225);     // Biru Medium (Royal Blue)
