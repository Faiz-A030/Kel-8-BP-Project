...
public class GameBase extends JPanel {
    ...
    public void setupUI() {
        ...
        scoreLabel.setFont(GameComp.FONT_SCORE);
        ...
        pauseButton.setFont(GameComp.FONT_STATUS);
        pauseButton.setMaximumSize(new Dimension(240, 50));
        pauseButton.setBackground(GameComp.COLOR_BG);
        ...
        statusPanel.setBackground(GameComp.COLOR_BG_STATUS);
        statusPanel.setPreferredSize(new Dimension(Board.CANVAS_WIDTH, 30));

        statusBar = new JLabel();
        statusBar.setFont(GameComp.FONT_STATUS);
        ...
        boardPanel.setBackground(GameComp.COLOR_BG);
    ...
    public void showPauseMenu() {
        ...
        continueButton.setFont(GameComp.FONT_STATUS);
        continueButton.setMaximumSize(new Dimension(240, 50));
        continueButton.setBackground(GameComp.COLOR_BG);
        ...
        exitButton.setFont(GameComp.FONT_STATUS);
        exitButton.setMaximumSize(new Dimension(240, 50));
        exitButton.setBackground(GameComp.COLOR_BG);
